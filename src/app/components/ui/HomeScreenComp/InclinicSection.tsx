...
import { dentist, dietitian, gastroenterologist, generalDoctor, generalSurgeon, gynecologist, orthopedist, pediatrician, physiotherapist } from '../../../../../public/assets';
        ...
        <div className='w-full mx-4 flex flex-col gap-10'>
            <div className=''>
                <div className='space-y-2'>
                    <h1 className='font-bold text-xl'>Book an appointment for an in-clinic consultation</h1>
                    <p className='font-light'>Find experienced doctors across all specialties</p>
                </div>
            </div>
                ...
                >
                    {inClinicOpds.map((opd) => (
                        <SwiperSlide key={opd.id} className='p-4'>
                            <Image src={opd.image} alt={opd.name} className='border border-[#52D2CF]  rounded-md p-4' />
