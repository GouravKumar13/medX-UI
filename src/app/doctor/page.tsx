...
import { ConsultaionSwiper } from '../components/HomePage/inclinicSection'
        ...
        <div className='flex '>
            <div className='w-[70%] '>
                {doctorDetails.map(({
                    ...
                    return (
                        <div key={index} className='border-y py-9 flex items-center justify-center gap-10'>
                            {avatar}
                            <div>
                                <div className='text-blue-500 text-lg'>{name}</div>
                                <div className='text-sm text-slate-500 font-light'>{education}</div>
                                <div className='font-light'>{short_desc}</div>
                                <div className='font-light'>{hospitals}</div>
                                <div className='font-light'>{fees} Consultation fee at clinic</div>
                            </div>
                            <div className='flex flex-col gap-2 items-center justify-center'>
                                ...
                                <div> <button className="group/button relative inline-flex flex-col items-center justify-center overflow-hidden rounded-md bg-[#52D2CF] px-4 py-1.5 text-xs font-normal text-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-[#7cc2c1] ">
                                    <span className="text-sm">Book CLinic Visit</span>
                                    <span className=''>No Booking Fee</span>
            ...
            <div className='flex flex-col w-[30%] items-center p-8 m-2'>
                <h1 className='text-lg font-medium'>Connect with doctors online, available 24/7,<br /> from the comfort of your home.</h1>
